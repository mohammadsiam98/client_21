								...
								<div class="login_form">
									...
									<form action="action.php" method="POST">
										...
										<div class="input-group mb-2 mr-sm-2">
										    <input type="text" class="form-control" name="email" id="inlineFormInputGroupUsername2" placeholder="User Email">
										...
										<button type="submit" name="btn_login" class="btn btn-log btn-block btn-thm">Log In</button>
								...
								<div class="sign_up_form">
									...
									<form action="action.php" method="POST">
										...
										<div class="form-group input-group">
										    <input type="text" class="form-control" id="exampleInputName" name="name" placeholder="User Name">
										    <div class="input-group-prepend">
										    	<div class="input-group-text"><i class="flaticon-user"></i></div>
										    </div>
										</div>
										...
										<button type="submit" name="btn_register" class="btn btn-log btn-block btn-thm">Sign Up</button>
